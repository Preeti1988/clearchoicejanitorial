    ...
    <div class="body-main-content">
        <div class="d-flex mb-2">
            <h6 class="p-0 total-count"><a href="{{ route('TeamActive') }}"><i class="fa fa-arrow-left" aria-hidden="true"
                        style="color: #7BC043"></i> </a> Employee Pending Requests
                <b>({{ $count }})</b>
            </h6>
        </div>
                ...
                @foreach ($datas as $val)
                    <div class="info-card">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2">
                                <div class="text-end">
                                    <a href="{{ url('member-request-detail/' . encryptDecrypt('encrypt', $val->userid)) }}"
                                        class="view-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16"
