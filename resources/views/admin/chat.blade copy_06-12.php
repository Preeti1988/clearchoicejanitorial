            ...
            <div class="chat-userlist-sidebar-head">
                <div class="chat-panel-sidebar-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M17 9C17 12.87 13.64 16 9.5 16L8.57001 17.12L8.02 17.78C7.55 18.34 6.65 18.22 6.34 17.55L5 14.6C3.18 13.32 2 11.29 2 9C2 5.13 5.36 2 9.5 2C12.52 2 15.13 3.67001 16.3 6.07001C16.75 6.96001 17 7.95 17 9Z" stroke="#4F5168" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M22 12.86C22 15.15 20.82 17.18 19 18.46L17.66 21.41C17.35 22.08 16.45 22.21 15.98 21.64L14.5 19.86C12.08 19.86 9.92001 18.79 8.57001 17.12L9.5 16C13.64 16 17 12.87 17 9C17 7.95 16.75 6.96001 16.3 6.07001C19.57 6.82001 22 9.57999 22 12.86Z" stroke="#4F5168" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M7 9H12" stroke="#7BC043" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </div>
            ...
            <div class="chat-userlist-sidebar-body">
                <form action="{{ route('Chats') }}" method="POST">
                    ...
                    <div class="chat-userlist-filter">
                        <input type="text" name="search" class="form-control" value="{{ $search ?? '' }}" placeholder="Search by Employee Name">
                    ...
                    <a href="{{ url('chat/' . encryptDecrypt('encrypt', $val->userid)) }}">
                        <div class="chat-userlist-item">
                            ...
                            <div class="chat-userlist-item-content">
                                ...
                                <div class="unread-message"><span class="badge">{{ CountMSG($val->userid) }}</span>
                                </div>
                                @endif
        ...
        <div class="chat-panel-section">
            <div class="chat-panel-chat-header">
                <div class="chat-panel-user-item">
                    <div class="chat-panel-user-item-image"><img src="{{ custom_asset('public/assets/admin-images/user-default.png') }}"></div>
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Write a message." name="message" id="message-input">
                                <span class="form-attachemnt-icon">
                                    <a class="fs-24 ms-3 text-muted" id="image-attach" href="#!"><img src="{{ custom_asset('public/assets/admin-images/attachemnt.svg') }}"></a>
