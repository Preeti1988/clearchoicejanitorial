                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="btn-option-info wd40">
                        <div class="search-filter">
                            <div class="row g-2">
                                <div class="col-md-5">
                                    <a href="#" class="add-member-btn me-3" data-bs-toggle="modal" data-bs-target="#addTeamMember">Add Client
                                ...
                                <div class="col-md-7">
                                    <div class="search-form-group">
                                        ...
                                        <span class="search-icon"><img src="{{ asset('public/assets/admin-images/search-icon.svg') }}"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                @elseif(!$datas->isEmpty())
                                    @foreach ($datas as $val)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="viewbtn" href="{{ url('client-details/'.encryptDecrypt('encrypt', $val->id)) }}') }}">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('SaveClient') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" name="address" rows="4" required></textarea>
                            ...
                            <div class="modal-footer justify-content-center">
                                <div class="text-center">
                                    <button href="#" class="btn save-account" data-bs-toggle="modal"
                                        data-bs-target="#createTeamMemberAccount" type="submit">Save & Create Team Members Account</button>
