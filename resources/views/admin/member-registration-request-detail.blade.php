                ...
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="d-flex align-items-center">
                            <div class="info-image">
                                <img src="{{ asset('public/assets/admin-images/profile-img.jpg') }}" alt="image" class="img-fluid">
                            </div>
                    ...
                    <div class="col-md-2">
                        <div class="text-end action-buttons">
                            <div>
                                <a href="{{ url('approve-member/'.encryptDecrypt('encrypt', $data->userid)) }}" class="approve-btn">Approve Request</a>
                            </div>
                            <div class="mt-2">
                                <a href="{{ url('reject-member/'.encryptDecrypt('encrypt', $data->userid)) }}" class="reject-btn">Reject Request</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @if (isset($data->resume_file_name))
                        <div class="col-md-12">
                            <div class="download-box">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <img src="{{ asset('public/assets/admin-images/pdf-file.svg') }}" alt="image" class="img-fluid">
                                    </div>
                                    <div class="sizes ms-3">
                                        <p>{{ ucfirst(($data->resume_file_name)) ?? ''}}</p>
                                        <p class="mb-size">{{ ucfirst(($data->resume_file_size)) ?? ''}} MB</p>
                                    </div>
                                    <a href="#" class="download-btn ms-5">
