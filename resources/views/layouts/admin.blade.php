                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item @if ($currentURL == 'timehseet.list') active @endif">
                            ...
                            <a class="nav-link" href="{{ route('timesheet.list') }}">
                                ...
                                <span class="menu-title">Timesheet Reports</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item @if (Route::is('services.feedbacks') || Route::is('services.feedbacks')) active @endif">
                            <a class="nav-link" href="{{ route('services.feedbacks') }}">
                                <span class="menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <span class="menu-title">Service Feedback</span>
                            </a>
                        </li>
                        <li class="nav-item @if (Route::is('calender')) active @endif">
                            <a class="nav-link " href="{{ route('calender') }}">
                                ...
                                <span class="menu-title">Service Calendar </span>
                            </a>
                        </li>
                        <li class="nav-item @if (Route::is('services.incident_reports')) active @endif">
                            <a class="nav-link " href="{{ route('services.incident_reports') }}">
                                <span class="menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="currentColor" class="bi bi-file-text" viewBox="0 0 16 16">
                                        <path
                        ...
                        <li class="nav-item @if ($currentURL == 'privacy') active @endif">
                        ...
                        <li class="nav-item @if ($currentURL == 'terms') active @endif">
